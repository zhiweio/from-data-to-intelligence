# Ch 53 致谢与团队
!!! info "面包屑"
    [本书主页](./index.md) › [Part VIII 治理与复盘](./48-安全-合规与治理.md) › Ch 53
...
一座企业级数据平台不是一个人能建成的，这本书也不是。在合上这本书之前，我想把聚光灯从"架构"转向"人"——因为没有这些人的协作，再好的架构也只是图纸。
...
```
<p class="caption" markdown="span">**图 53-1** 团队结构</p>
...
<p class="caption" markdown="span">**表 53-1** 团队结构</p>


## 53.2 协作模式
这个项目最值得说的不是技术，而是协作模式——**咨询式交付**（[Ch 2](./02-从需求到蓝图：一个数据平台的诞生.md)）。NorthPeak 不是"接单干活"的外包，而是"驻场共建"的伙伴：架构师常驻 Aurora，和业务团队一起开白板、走数据、定口径。这种模式让架构决策始终贴着业务真实诉求，而非"闭门造车"。
...
linkStyle default stroke:#697077,stroke-width:2px
```
<p class="caption" markdown="span">**图 53-2** 协作模式</p>

这种节奏的副产品是"知识转移"——四年下来，Aurora 的数据团队从"依赖 NorthPeak"成长为"能自主维护和扩展平台"。这才是咨询交付的终极目标：**把自己交付到不需要自己**。
...
<p class="caption" markdown="span">**表 53-2** 学习资源</p>
